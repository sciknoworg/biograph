...
| `precision` | One of `day \| month \| season \| year \| decade \| century \| circa \| range`. `century` is for pre-modern subjects the source can place no more closely — an 8th-century alchemist's patronage, say. |
